    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Vende tus productos online y completa las ventas directamente por WhatsApp. 
            Sin complicaciones de pago, solo gestión de pedidos.
          </motion.p>
            ...
            {[
              {
                ...
                description: 'Muestra todos tus productos con imágenes, precios y descripciones.',
              },
              {
                icon: '🛒',
                title: 'Carrito de Compras',
                description: ' clientes seleccionan productos y completan datos de contacto.',
              },
              {
                icon: '💬',
                title: 'Pedido por WhatsApp',
                description: 'El pedido se envía automáticamente a tu WhatsApp para completar la venta.',
              },
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
